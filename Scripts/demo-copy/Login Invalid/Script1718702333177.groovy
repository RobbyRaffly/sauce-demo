...
WebUI.setText(findTestObject('Page_Swag Labs/input_Swag Labs_user-name'), 'hahaha')

WebUI.setEncryptedText(findTestObject('Page_Swag Labs/input_Swag Labs_password'), '373N5QL8KVQ=')
