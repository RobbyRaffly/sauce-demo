...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/span_Checkout Overview'),1)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/div_Price Total'),1)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/div_Payment Information'),1)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/div_Shipping Information'),1)
