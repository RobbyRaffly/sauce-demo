...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Open MenuAll ItemsAboutLogoutReset App _b0c94b'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Bike Light'), 0)
