...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/div_Sauce Labs Backpack'),1)
...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/input_Swag Labs_login-button'),1)
